...
extension UILabel {
    ...
    func addReadmoreButton(for fullText: String?,
                           trailingText: String,
                           moreText: String,
                           moreTextFont: UIFont,
        ...
        if let myText = fullText, myText.count >= 150 {
    ...
    func addReadlessButton(for fullText: String,
                           trailingText: String,
                           lessText: String,
                           lessTextFont: UIFont,
                           lessTextColor: UIColor) {
    ...
    func visibleTextLength(for fullText: String? = nil) -> Int {
        ...
        return fullText?.count ?? 0
    }
    
    func calculateHeight(with contentWidth: CGFloat,
                         text: String?,
                         font: UIFont,
                         lineHeightMultiple: CGFloat) -> CGFloat {
        ...
        return attributedString.height(withConstrainedWidth: contentWidth)
    }
}
